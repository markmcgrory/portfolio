...
const About = () => {
  return (
    <div className='about-container'>
      ...
      <p>Having equipped myself with this solid groundwork of practical programming skills as well as a lived experied of the value of  <strong>TDD, Agile practices, pair programming</strong>, etc., I am now looking for an opportunity to apply these skills commercially and to continue my journey as a developer.</p>
      </div>
    </div>
  );
};
